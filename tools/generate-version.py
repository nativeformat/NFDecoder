...
def main():
    ...
    generated_header_filename = os.path.join(output_dir, 'nfdecoder_generated_header.h')
    ...
    generated_header.write('#define NFDECODER_VERSION "' + git_count.strip() + '-' + git_describe.strip() + '"\n')
