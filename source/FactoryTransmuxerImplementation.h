...
class FactoryTransmuxerImplementation
    : public Factory,
      public std::enable_shared_from_this<FactoryTransmuxerImplementation> {
 public:
  FactoryTransmuxerImplementation(std::shared_ptr<Factory> wrapped_factory,
  ...
  virtual ~FactoryTransmuxerImplementation();
 ...
 private:
  ...
  std::shared_ptr<ManifestFactory> _manifest_factory;
  std::shared_ptr<DecrypterFactory> _decrypter_factory;
