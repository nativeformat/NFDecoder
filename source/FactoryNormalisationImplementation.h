...
class FactoryNormalisationImplementation : public Factory {
 public:
  FactoryNormalisationImplementation(std::shared_ptr<Factory> wrapped_factory);
  virtual ~FactoryNormalisationImplementation();
