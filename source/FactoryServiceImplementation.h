...
class FactoryServiceImplementation
    : public Factory,
      public std::enable_shared_from_this<FactoryServiceImplementation> {
 public:
  FactoryServiceImplementation(std::shared_ptr<Factory> wrapped_factory,
  ...
  virtual ~FactoryServiceImplementation();
